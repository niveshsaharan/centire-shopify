...
class WebhookControllerTest extends TestCase
{
    ...
    public function missing_webhook_job_returns_error()
    {
        ...
        $this->assertEquals('Missing webhook job for: missing-job-create', $response->exception->getMessage());
    }
    ...
    /** @test */
    public function valid_request_pushes_job_to_queue_with_data()
    {
        Queue::fake();
        $data = file_get_contents(__DIR__ . '/../Fixtures/webhook.json');
        $this->headers['HTTP_X_SHOPIFY_HMAC_SHA256'] = $this->hmac($data);
